...
def morethings():
    mver=1.6
    global rc,pin,used,cps,qwe,loger,doc,ver,fn,ast,rozlist
...
9.?(6星)            1000rmb
        ...
        if p<26: #25
            ...
            print("               ")
            p=p-p
#version=15.1,line in 2142 CrosWuft,2022,6,7,s2 TM
#v15.1特殊Tips:这次版本我做了很久，也是积累和创作时间最久的一次，从几周前就开始思考构造了，但为了版本完整性，我没有选择正常的‘每周发布’，由于有些东西对于我来说非常难，特别是'cs'和'math'的重构，我花了很多时间和精力，到写这段话为止，已经是凌晨一点多了，我很疲惫，但也很高兴，因为我写完了那么长的东西，不出意外的话，这次应该是中考前的最后一次更新了，也是我的生日作，如果你能看到这句话，那就请祝我生日快乐吧，我的生日是六月23日！
